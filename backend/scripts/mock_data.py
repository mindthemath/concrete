...
print(f"Range of values: {min(concrete_synthetic.values(), key=lambda x: x['concrete_compressive_strength_mpa'])} to {max(concrete_synthetic.values(), key=lambda x: x['concrete_compressive_strength_mpa'])}")